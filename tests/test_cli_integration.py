...
class TestCLIIntegration:
    ...
    def test_batch_convert_multiple_files(self, runner, sample_txt_file, sample_md_file, tmp_path, mock_successful_processing):
    ...
    def test_convert_permission_error_on_export(self, runner, sample_txt_file, tmp_path, mock_successful_processing, mocker):
...
class TestCLIInteractiveFeatures:
    ...
    def sample_file_with_flashcards(self, tmp_path, mocker):
        ...
        mock_generator_instance.export_to_csv.return_value = (True, {
            "total_flashcards": 2,
            "exported_flashcards": 2,
            "skipped_invalid": 0,
            "qa_cards": 1,
    ...
    def test_interactive_edit_flashcard(self, runner, sample_file_with_flashcards, tmp_path):
        ...
        # Simulate: edit (e) -> select card 1 -> proceed -> new question -> new answer -> save -> continue (c) -> export (y)
    ...
    def test_interactive_delete_flashcard(self, runner, sample_file_with_flashcards, tmp_path):
        ...
        # Simulate: delete (d) -> select card 1 -> confirm -> continue (c) -> export (y)
        user_input = "d\n1\ny\nc\ny\n"
    ...
    def test_interactive_add_flashcard(self, runner, sample_file_with_flashcards, tmp_path):
        ...
        # Simulate: add (a) -> question -> answer -> type -> continue (c) -> export (y)
